...
def visjs(request):
    ...
    if 'scanfile' not in request.session:
        ...
        '''
        return render(request, 'nmap_network.html', r)
                ...
                for pobj in i['ports']['port']:
                    ...
                    if 'service' in p:
                        if '@version' in p['service']:
                            portnodes[addressmd5][p['@portid']]['version'] = p[
                                'service'
                            ]['@version']
                        else:
                            portnodes[addressmd5][p['@portid']][
                        ...
                        if '@product' in p['service']:
                            portnodes[addressmd5][p['@portid']]['product'] = p[
                                'service'
                            ]['@product']
                        else:
                            portnodes[addressmd5][p['@portid']][
                        ...
                        if '@extrainfo' in p['service']:
                            portnodes[addressmd5][p['@portid']]['extrainfo'] = p[
                                'service'
                            ]['@extrainfo']
                        else:
